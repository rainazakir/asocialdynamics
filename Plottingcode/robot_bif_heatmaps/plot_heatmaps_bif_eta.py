...
opdir= '/Volumes/My_Passport/argosim2/Runs/acc/data/recrobqr0.66_opp/'

#opdir='/Volumes/My_Passport/argosim2/Runs/journal/data/ciqr0.92_varynoisemore/'
opdir='/Volumes/My_Passport/argosim2/Runs/journal/data/ciqr1_varynoisemorenew/'
opdir='/Volumes/My_Passport/argosim2/Runs/journal/data/ciqr0.92_varynoisemore/'

#opdir='/Volumes/My_Passport/argosim2/Runs/journal/data/T1_ci_1.0/'
#opdir='/Volumes/My_Passport/argosim2/Runs/journal/data/ciqr1_varynoise/'
data_files = []
...
# plt.show()
#plt.hist2d(dump_list_x_points, dump_list_y_points, bins=[15,22], cmap='Reds', norm=M.colors.LogNorm())
#24,33
plt.hist2d(dump_list_x_points, dump_list_y_points, bins=[18,99], cmap='Reds', norm=M.colors.LogNorm())
...
xx = 0
if withBif:
    for root, dirs, files in os.walk('/Volumes/My_Passport/argosim2/Runs/journal/data/bifqr0.92ci'):
        for file in files:
            with open(os.path.join(root, file), "r") as auto:
                ...
                # plt.figure(xx)
                if(file.split('_')[7]=='1.txt'):#1
                    plt.plot(x, a, 'limegreen', alpha=1, linewidth=14)
                else:
...
for root, dirs, files in os.walk('/Volumes/My_Passport/argosim2/Runs/journal/data/bifqr0.92ci2_basic/'):
    for file in files:
        with open(os.path.join(root, file), "r") as auto:
            print(auto)
            lines = list(line for line in (l.strip() for l in auto) if line)
...
plt.plot(0.05, -0.72, "or", markersize=36, color="black")
plt.plot(0.05, 0.54, "or", markersize=36, color="black")
plt.plot(0.05, 0.68, "or", markersize=36, color="black")
...
plt.xlabel(r'noise $n$', fontsize=64)
...
#plt.savefig('/Volumes/My_Passport/argosim2/Runs/journal/images/NEWcifig0.92extendxaxis_T2NEWrob_bif_heatmaps_qr1_1_varynoise_ci.pdf', dpi=300, bbox_inches='tight')

    # plt.plot(axis, pointyaxis)
#legend1 = plt.legend(['0.1', '0.2', '0.3', '0.5', '0.8', '0.9'], title='Zealot Proportion', fontsize=32)
#plt.setp(legend1.get_title(), fontsize=32)
#plt.savefig('images/T1_FIG3_SYN_1.0.pdf', dpi=800, bbox_inches='tight')
plt.show()
