...
opdir = '/Volumes/My_Passport/argosim2/Runs/journal/data/an_ci_qr0.66_varynrA_t1/'

opdir = '/Volumes/My_Passport/argosim2/Runs/journal/data/an_ci_qr0.82_varynrA_0.15_t1/'
opdir = '/Volumes/My_Passport/argosim2/Runs/journal/data/an_ci_qr0.66_varynrA_t2/'
opdir = '/Volumes/My_Passport/argosim2/Runs/journal/data/an_bif_ds_varynrA_0.82_n0.1_newCI1_SAMPN/'
opdir = '/Volumes/My_Passport/argosim2/Runs/journal/data/an_bif_ds_varynrA_0.92_n0.1_newCI2_SAMPN/'
opdir = '/Volumes/My_Passport/argosim2/Runs/journal/data/antN_ds_qr0.925_varynrA/'
data_files = []
...
# plt.show()
plt.hist2d(dump_list_x_points, dump_list_y_points, bins=[9,92], cmap='Reds',norm=M.colors.LogNorm())
#9,58
...
xx = 0
if withBif:
    print("Comes to printing bifurcations: ")
    for root, dirs, files in os.walk('/Volumes/My_Passport/argosim2/Runs/journal/data/an_bif_ci_varynrA_0.925/'):
        for file in files:
            print(files)
            with open(os.path.join(root, file), "r") as auto:
                ...
                # plt.figure(xx)
                #if(file.split('_')[7]=='3.txt' or file.split('_')[7]=='2.txt'): # 1 and 3
                if(file.split('_')[7]=='1.txt' or file.split('_')[7]=='1.txt'): # 1 and 3
...
for root, dirs, files in os.walk('/Volumes/My_Passport/argosim2/Runs/journal/data/bif_basic_ci2_0.92/'):
    for file in files:
        print(files)
        with open(os.path.join(root, file), "r") as auto:
            print(auto)
            ...
            if(file.split('_')[4]=='1.txt' or file.split('_')[4]=='1.txt'):
                plt.plot(x, a, 'palegreen',linestyle="dotted", alpha=1, linewidth=24)
                #plt.plot(x, b, 'limegreen', alpha=1, linewidth=24)

            else:
                plt.plot(x, a, 'cornflowerblue', linestyle="dotted", alpha=1, linewidth=24)
                #plt.plot(x, b, '#F9D576', alpha=1, linewidth=14)
...
# t.set_fontsize(29)
#plt.plot(, a, 'cornflowerblue', linestyle="dotted", alpha=1, linewidth=24)

#ci 0.66 0.3: 40r, 10u/b
#ci 0.66 0.3: 42r, 8u/b
#ci 0.66 0.3: 36r, 14u/b

#ci 0.66 0.5: 43r, 10u/b
#ci 0.66 0.5: 37r, 8u/b
#ci 0.66 0.5: 42r, 14u/b

#plt.plot(0.3, 0.54, "or", markersize=36, color="black")
#plt.plot(0.3, 0.62, "or", markersize=36, color="black")
#plt.plot(0.3, 0.45, "or", markersize=36, color="black")


#plt.plot(0.5, 0.67, "or", markersize=36, color="black")
#plt.plot(0.5, 0.5, "or", markersize=36, color="black")
#plt.plot(0.5, 0.64, "or", markersize=36, color="black")


#ci 0.92 0.3: 19r, 10u/b
#ci 0.92 0.3: 35r, 8u/b
#ci 0.92 0.3: 15r, 14u/b

#ci 0.92 0.5: 38r, 10u/b
#ci 0.92 0.5: 39r, 8u/b
#ci 0.92 0.5: 38r, 14u/b

plt.plot(0.3, 0.76, "or", markersize=36, color="black")
plt.plot(0.3, -0.65, "or", markersize=36, color="black")
plt.plot(0.3, 0.56, "or", markersize=36, color="black")


plt.plot(0.5, -0.72, "or", markersize=36, color="black")
plt.plot(0.5, 0.54, "or", markersize=36, color="black")
plt.plot(0.5, 0.68, "or", markersize=36, color="black")
...
#plt.savefig('/Volumes/My_Passport/argosim2/Runs/journal/images/NEWnDOTSROBcit2_rob_bif_heatmaps_qr1.5_0.92_ONLYA.pdf', dpi=300, bbox_inches='tight')

    # plt.plot(axis, pointyaxis)
#legend1 = plt.legend(['0.1', '0.2', '0.3', '0.5', '0.8', '0.9'], title='Zealot Proportion', fontsize=32)
#plt.setp(legend1.get_title(), fontsize=32)
#plt.savefig('images/T1_FIG8_ANT_0.82_NOISE_0.15.pdf.pdf', dpi=800, bbox_inches='tight')
plt.show()
